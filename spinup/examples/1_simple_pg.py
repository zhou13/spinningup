...
def train(
    ...
    def train_one_epoch():
        ...
        observation, _ = env.reset()  # first obs comes from starting distribution
        ...
        while True:
            ...
            if (not finished_rendering_this_epoch) and render:
                # In gymnasium, render() were executed during step(), which is too slow.
                # Workaround it by turning off render_mode temporarily.
            ...
            if done:
                ...
                # reset episode-specific variables
                (observation, _), done, ep_rewards = env.reset(), False, []
